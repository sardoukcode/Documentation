var image = document.querySelector("body").addEventListener("mouseover", function(){
...
var firstImage = document.querySelector("body").addEventListener("mouseout", function(){
